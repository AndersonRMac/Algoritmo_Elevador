"""
O problema do elevador - versão 2

trabalho: sandro quer um elevador inteligente
...
andares_do_predio = int(input('Digite a quantidade de andares do seu predio: ')) + 1
andar_da_pessoa = int(input('Qual andar você se encontra? ')) + 1
while(andar_da_pessoa > andares_do_predio):
    andar_da_pessoa = int(input('Andar inválido!!! Redigite o andar que você se encontra? '))
andar_pessoa_vai = int(input('Qual andar você deseja ir? ')) + 1
